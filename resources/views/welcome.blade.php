            ...
            <div class="max-w-5xl mx-auto">
                ...
                <div class="bg-white rounded-3xl shadow-2xl p-8 md:p-12 mb-8 slide-in" style="animation-delay: 0.4s;">
                    ...
                    <div class="text-center">
                        <a href="{{ env('FRONTEND_WEBSITE_URL', 'http://localhost:8080') }}/evenements" class="inline-block bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-bold text-2xl px-16 py-6 rounded-full shadow-2xl transform hover:scale-110 transition-all duration-300 animate-pulse">
                        ...
                        <p class="text-gray-600 mt-6 text-base font-medium">
                            Date limite d'inscription : <span class="font-bold text-red-600 text-lg">10 Avril 2026</span>
                        </p>
